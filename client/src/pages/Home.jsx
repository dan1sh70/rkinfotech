      ...
      <section className="hero">
        ...
        <div className="container hero__inner">
          ...
          <div className="hero__content">
            <div className="hero__eyebrow animate-fade-up delay-1" style={{ background: 'rgba(0,0,0,0.05)', color: '#000', border: '1px solid rgba(0,0,0,0.1)' }}>
              <span className="mono" style={{ fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.05em' }}>FROM INBOX TO OFFER</span>
            </div>

            <h1 className="hero__title animate-fade-up delay-2" style={{ fontSize: 'clamp(3.5rem, 7vw, 5.5rem)', lineHeight: 1, letterSpacing: '-0.04em' }}>
              Tech Careers.<br />
              Built for<br />
              <span style={{ color: 'var(--accent)' }}>Professionals.</span>
            </h1>

            <p className="hero__desc animate-fade-up delay-3" style={{ maxWidth: '400px', fontSize: '1.1rem', marginTop: '1.5rem', color: 'var(--text-secondary)' }}>
              RK Infotech engineers career breakthroughs. ATS-optimized resumes,
              expert training, and guaranteed placements.
            </p>

            <div className="hero__actions animate-fade-up delay-4" style={{ marginTop: '2.5rem' }}>
              <Link to="/pricing" className="btn btn-primary hero__btn-main" style={{ background: 'var(--accent)', color: '#fff', padding: '1rem 2rem', borderRadius: '100px', fontWeight: 600 }}>
